...
data-on-init="function(e){ ... }" | event handler after grid initilization<ul><li>e.sender - current grid js instance</li></ul>
data-on-load="function(e){ ... }" | event handler after data is rendered<ul><li>e.sender - current grid js instance</li></ul>
