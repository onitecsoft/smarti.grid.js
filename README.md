...
data-on-init="function(e){ ... }" | event handler after grid initilization<br>arguments: * e.sender - current grid js instance
data-on-load="function(e){ ... }" | event handler after data is rendered<br>arguments: * e.sender - current grid js instance
